...
export const TopOffer = () => {
  ...
  return (
    <>
       <span className="offer-span">Home /</span><span> Top Offer</span>
      <div className="Top-offer-div">
        <div className="Top-offer-text-div">
          <h1>TOP OFFERS</h1>
          <p className="Top-offer-div-p">Too good to pass up! Shop our best offers now.</p>
        </div>
        <hr className="Top-offer-hr" />
        <div>
          <img className="topoffer-img"
        ...
        <hr className="Top-offer-hr"/>
        <div>
          <p className="top-offer-bottom-text">About Top Offers from Bath & Body Works</p>
          ...
          <h3 className="offer-bottom-text-p">How do you get Bath & Body Works coupons mailed to you?</h3>
          <p className="offer-bottom-text-p">
          ...
          <h3 className="offer-bottom-text-p">Does Bath & Body Works offer free shipping?</h3>
          ...
          <h3 className="offer-bottom-text-p">How many promo codes can you redeem per online order?</h3>
          ...
          <h3 className="offer-bottom-text-p">What is the Bath & Body Works return policy?</h3>
          <p className="offer-bottom-text-p">
