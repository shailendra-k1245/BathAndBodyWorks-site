...
import "./aboutsoap.scss"

export default function Aboutsoap() {
  return (
    <div className='aboutSoap'>
          <h4>About Hand Soaps & Sanitizers from Bath & Body Works</h4>
          ...
          <p>P.S. Soap is a great way to keep germs away, but what if you’re on the go? Grab one of our PocketBac hand sanitizers! Enriched with shea extract, vitamin E, 71% alcohol and aloe, Bath & Body Works hand sanitizers kill 99.9% of most common germs and keep your hands clean and soft. Plus, they look super cute when you pop them into a PocketBac holder.</p>

          <p>*According to FDA: There is currently no evidence that anti-bacterial soaps are any more effective at preventing illness than normal soap and water. See more at FDA.gov.</p>
        </div>
  )
}
